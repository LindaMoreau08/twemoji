...
class TwemojiTest < Minitest::Test
  ...
  IMAGE_ROOT = Twemoji.configuration.asset_root
  def setup
  ...
  def test_parse_plus_one
    expected = %(<img draggable="false" title=":+1:" alt="👍" src="#{IMAGE_ROOT}/svg/1f44d.svg" class="emoji">)
  ...
  def test_parse_minus_one
    expected = %(<img draggable="false" title=":-1:" alt="👎" src="#{IMAGE_ROOT}/svg/1f44e.svg" class="emoji">)

    assert_equal expected, Twemoji.parse(":-1:")
  end

  def test_parse_html_string
    expected = %(I like chocolate <img draggable="false" title=":heart_eyes:" alt="😍" src="#{IMAGE_ROOT}/svg/1f60d.svg" class="emoji">!)
  ...
  def test_parse_document
    ...
    expected = %(<p>I like chocolate <img draggable="false" title=":heart_eyes:" alt="😍" src="#{IMAGE_ROOT}/svg/1f60d.svg" class="emoji">!</p>)
  ...
  def test_parse_option_file_ext_png
    expected = %(I like chocolate <img draggable="false" title=":heart_eyes:" alt="😍" src="#{IMAGE_ROOT}/72x72/1f60d.png" class="emoji">!)
  ...
  def test_parse_option_class_name
    expected = %(I like chocolate <img draggable="false" title=":heart_eyes:" alt="😍" src="#{IMAGE_ROOT}/svg/1f60d.svg" class="twemoji">!)

    assert_equal expected, Twemoji.parse("I like chocolate :heart_eyes:!", class_name: 'twemoji')
  end

  def test_parse_option_single_img_attr
    expected = %(I like chocolate <img draggable="false" title=":heart_eyes:" alt="😍" src="#{IMAGE_ROOT}/svg/1f60d.svg" class="twemoji" style="height: 1.3em;">!)
  ...
  def test_parse_option_multiple_img_attrs
    expected = %(I like chocolate <img draggable="false" title=":heart_eyes:" alt="😍" src="#{IMAGE_ROOT}/svg/1f60d.svg" class="twemoji" style="height: 1.3em;" width="20">!)
  ...
  def test_parse_option_img_attr_callable
    ...
    expected = %(I like chocolate <img draggable="false" title="heart_eyes" alt="heart_eyes" src="#{IMAGE_ROOT}/svg/1f60d.svg" class="twemoji" style="height: 1.3em;">!)
  ...
  def test_parse_flag_img_alt
    expected = %(<img draggable=\"false\" title=\":flag-sg:\" alt=\"🇸🇬\" src=\"#{IMAGE_ROOT}/svg/1f1f8-1f1ec.svg\" class=\"emoji\">)
  ...
  def test_parse_by_unicode
    expected = %(<img draggable="false" title=":heart_eyes:" alt="😍" src="#{IMAGE_ROOT}/svg/1f60d.svg" class="emoji">)

    assert_equal expected, Twemoji.parse("😍")
  end

  def test_parse_by_unicode_flag
    expected = %(<img draggable=\"false\" title=\":flag-my:\" alt=\"🇲🇾\" src=\"#{IMAGE_ROOT}/svg/1f1f2-1f1fe.svg\" class=\"emoji\">)
  ...
  def test_parse_by_unicode_attr
    expected = %(<img draggable="false" title=":heart_eyes:" alt="😍" src="#{IMAGE_ROOT}/svg/1f60d.svg" class="twemoji" aria-label="emoji: heart_eyes">)
  ...
  def test_parse_by_unicode_multiple
    expected = %(<img draggable="false" title=":cookie:" alt="🍪" src="#{IMAGE_ROOT}/svg/1f36a.svg" class="emoji" aria-label="emoji: cookie"><img draggable="false" title=":birthday:" alt="🎂" src="#{IMAGE_ROOT}/svg/1f382.svg" class="emoji" aria-label="emoji: birthday">)
    aria_label = ->(name) { 'emoji: ' + name.gsub(":", '') }
    assert_equal expected, Twemoji.parse("🍪🎂", img_attrs: {'aria-label'=> aria_label } )
  end

    def test_parse_by_unicode_multiple_html
    expected = %(<p><img draggable="false" title=":cookie:" alt="🍪" src="#{IMAGE_ROOT}/svg/1f36a.svg" class="emoji" aria-label="emoji: cookie"><img draggable="false" title=":birthday:" alt="🎂" src="#{IMAGE_ROOT}/svg/1f382.svg" class="emoji" aria-label="emoji: birthday"></p>)
    aria_label = ->(name) { 'emoji: ' + name.gsub(":", '') }
  ...
  def test_parse_empty_class_name
    expected = %(<img draggable="false" title=":flag-br:" alt="🇧🇷" src="#{IMAGE_ROOT}/svg/1f1e7-1f1f7.svg">)
    actual =  Twemoji.parse('🇧🇷', class_name: nil)
    assert_equal expected, actual
    actual =  Twemoji.parse('🇧🇷', class_name: '')
    assert_equal expected, actual
  end
end
